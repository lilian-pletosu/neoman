...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductSection-76549d77.js
import { u as useCartStore, a as useWishlistStore } from "./FrontLayout-fec85b0a.js";
========
import { u as useCartStore, a as useWishlistStore, f as formatPrice } from "./FrontLayout-2d8a94b7.js";
>>>>>>>> origin/master:bootstrap/ssr/assets/ProductSection-e0590dc2.js
              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (__props.sale) {
                      _push3(`<div class="flex flex-row space-x-1"${_scopeId2}><p class="font-mulish text-sm line-through font-medium"${_scopeId2}>${ssrInterpolate(unref(formatPrice)(product.price))} ${ssrInterpolate(_ctx.__("lei"))}</p><span class="bg-red-400 text-white text-xs font-medium me-2 px-0.5 sm:px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300"${_scopeId2}>${ssrInterpolate(product.sale)}</span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (product.final_price) {
                      _push3(`<p class="font-mulish text-xl font-medium"${_scopeId2}>${ssrInterpolate(unref(formatPrice)(product.final_price))} ${ssrInterpolate(_ctx.__("lei"))}</p>`);
                    } else {
                      _push3(`<p class="font-mulish text-xl font-medium"${_scopeId2}>${ssrInterpolate(product.price)} ${ssrInterpolate(_ctx.__("lei"))}</p>`);
                    }
                    _push3(`</div><div class="${ssrRenderClass([unref(cartStore).checkIfProductExistInCart(product.id) ? "bg-[#1FC8F3]" : "bg-white", "shadow rounded-lg transition p-4 sm:p-4 hover:scale-110 hover:bg-[#1FC8F3] cursor-pointer group/cart"])}"${_scopeId2}><svg class="${ssrRenderClass([unref(cartStore).checkIfProductExistInCart(product.id) ? "text-white" : "text-black", "h-4 w-4 group-hover/cart:text-white"])}" fill="currentColor" xmlns="http://www.w3.org/2000/svg"${_scopeId2}><path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0"${_scopeId2}></path></svg></div></div></div>`);
                  } else {
                    return [
