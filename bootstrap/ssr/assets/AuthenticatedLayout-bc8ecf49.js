import { unref, mergeProps, withCtx, renderSlot, useSSRContext, computed, ref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrInterpolate, ssrRenderClass } from "vue/server-renderer";
import { _ as _sfc_main$4 } from "./Dropdown-7075589d.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="min-h-screen bg-gray-100"><nav class="bg-white border-b border-gray-100"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex justify-between h-16"><div class="flex"><div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">`);
