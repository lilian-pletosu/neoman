...
import { u as useCartStore, a as useWishlistStore } from "./FrontLayout-d389c584.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${ssrInterpolate(__props.title)}</h2></div><div class="w-16 flex space-x-2"><div id="swiper-button-prev" class="swiper-button-prev rounded-3xl flex items-center justify-center border border-slate-600 w-full h-auto">`);
      _push(ssrRenderComponent(unref(ArrowLeftIcon), { class: "w-4" }, null, _parent));
      _push(`</div><div id="swiper-button-next" class="swiper-button-next rounded-3xl flex justify-center border border-slate-600 w-full h-auto">`);
      _push(ssrRenderComponent(unref(ArrowRightIcon), { class: "w-4" }, null, _parent));
      _push(`</div></div></div>`);
            ...
            ssrRenderList(__props.products, (product, key) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "p-2" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="container-rounded flex items-center justify-center bg-white border border-slate-100 dark:bg-slate-100 w-96 h-[100px] xs:h-[350px] 1xs:h-[400px] 2xs:h-80 3xs:h-96 md:h-[380px] 2xl:h-[450px] 3xl:h-[450px] relative group/card"${_scopeId2}><div class="absolute z-20 flex items-center rounded left-2 top-2 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 w-auto px-2 h-auto shadow border-1 border-slate-600"${_scopeId2}><span class="text-xs text-white font-semibold"${_scopeId2}>Credit 0%</span></div><div class="hover:cursor-pointer"${_scopeId2}><div${_scopeId2}><div class="static"${_scopeId2}><div class="w-12 absolute left-2 top-2 z-10"${_scopeId2}><img class="mix-blend-multiply"${ssrRenderAttr("src", product.brand.image)}${ssrRenderAttr("alt", product.brand.name)}${_scopeId2}></div><div class="absolute group right-2 top-2 bg-white rounded-xl p-2 bg-opacity-40 cursor-pointer"${_scopeId2}>`);
                    ...
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div${_scopeId3}><div class="mt-2"${_scopeId3}><img${ssrRenderAttr("src", product.image)} alt="Product Image" class="transition hover:scale-110 object-cover opacity-100 mix-blend-multiply"${_scopeId3}></div></div><div class="relative mt-3"${_scopeId3}><p class="font-mulish font-bold text-shadow-lg text-xs md:text-lg text-black"${_scopeId3}>${ssrInterpolate(product.name.slice(0, 42) + "...")}</p></div>`);
                        } else {
                          return [
                            ...
                            createVNode("div", { class: "relative mt-3" }, [
                    ...
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="${ssrRenderClass([unref(cartStore).checkIfProductExistInCart(product.id) ? "text-white" : "text-black", "h-4 w-4 group-hover/cart:text-white"])}"${_scopeId3}><path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5M3.14 5l1.25 5h8.22l1.25-5zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0m9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0"${_scopeId3}></path></svg>`);
                        } else {
                          return [
                    ...
                    return [
                      createVNode("div", { class: "container-rounded flex items-center justify-center bg-white border border-slate-100 dark:bg-slate-100 w-96 h-[100px] xs:h-[350px] 1xs:h-[400px] 2xs:h-80 3xs:h-96 md:h-[380px] 2xl:h-[450px] 3xl:h-[450px] relative group/card" }, [
                        createVNode("div", { class: "absolute z-20 flex items-center rounded left-2 top-2 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 w-auto px-2 h-auto shadow border-1 border-slate-600" }, [
                          createVNode("span", { class: "text-xs text-white font-semibold" }, "Credit 0%")
                        ]),
