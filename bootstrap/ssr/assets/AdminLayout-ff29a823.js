...
import { _ as _sfc_main$4 } from "./ShortLogo-3a83a5f7.js";
...
const _sfc_main = defineComponent({
  components: { CustomNotification: _sfc_main$1, Notification, NotificationGroup, NavBar, Sidebar: _sfc_main$3, Head },
  props: {
    currentRoute: String,
    title: String
  },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div id="main-content" class="col-span-12 lg:col-span-9 xl:col-span-10 justify-between h-screen w-full relative"><main><div class="px-4 pt-[88px]">`);
