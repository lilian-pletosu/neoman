...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductPage-684ff6f9.js
...
========
import { u as useCartStore, a as useWishlistStore, _ as _sfc_main$3, f as formatPrice, b as _sfc_main$4 } from "./FrontLayout-2d8a94b7.js";
import { Link, router } from "@inertiajs/vue3";
import { route } from "ziggy-js";
import { _ as _sfc_main$5 } from "./ProductSection-e0590dc2.js";
>>>>>>>> origin/master:bootstrap/ssr/assets/ProductPage-f689a21e.js
...
========
                _push2(`<div class="flex flex-row items-start lg:flex-col"${_scopeId}><button style="${ssrRenderStyle((image == null ? void 0 : image.image1) != null ? null : { display: "none" })}" class="${ssrRenderClass([{ "border-gray-900": (image == null ? void 0 : image.image1) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}" type="button"${_scopeId}><img${ssrRenderAttr("src", image == null ? void 0 : image.image1)} alt="" class="h-full w-full object-cover"${_scopeId}></button><button style="${ssrRenderStyle((image == null ? void 0 : image.image2) != null ? null : { display: "none" })}" class="${ssrRenderClass([{ "border-gray-900": (image == null ? void 0 : image.image2) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}" type="button"${_scopeId}><img${ssrRenderAttr("src", image == null ? void 0 : image.image2)} alt="" class="h-full w-full object-cover"${_scopeId}></button><button style="${ssrRenderStyle((image == null ? void 0 : image.image3) != null ? null : { display: "none" })}" class="${ssrRenderClass([{ "border-gray-900": (image == null ? void 0 : image.image3) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}" type="button"${_scopeId}><img${ssrRenderAttr("src", image.image3)} alt="" class="h-full w-full object-cover"${_scopeId}></button><button style="${ssrRenderStyle((image == null ? void 0 : image.image4) != null ? null : { display: "none" })}" class="${ssrRenderClass([{ "border-gray-900": (image == null ? void 0 : image.image4) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}" type="button"${_scopeId}><img${ssrRenderAttr("src", image == null ? void 0 : image.image4)} alt="" class="h-full w-full object-cover"${_scopeId}></button></div>`);
>>>>>>>> origin/master:bootstrap/ssr/assets/ProductPage-f689a21e.js
              });
...
========
              _push2(`</button></div><div class="mt-2 flex justify-between items-center"${_scopeId}><img${ssrRenderAttr("src", (_a2 = __props.product.brand) == null ? void 0 : _a2.image)} alt="" class="w-16"${_scopeId}><div class="flex items-center dark:text-slate-300"${_scopeId}><div class="flex items-center"${_scopeId}>${ssrInterpolate(_ctx.__("product_code"))}: </div><p class="ml-2 text-sm font-medium text-gray-500"${_scopeId}>${ssrInterpolate(__props.product.product_code)}</p></div></div><!--[-->`);
>>>>>>>> origin/master:bootstrap/ssr/assets/ProductPage-f689a21e.js
              ...
              if (!__props.product.has_discount) {
                _push2(`<h1 class="dark:text-slate-300 text-3xl font-bold"${_scopeId}>${ssrInterpolate(unref(formatPrice)(__props.product.price))}</h1>`);
              } else {
                _push2(`<span class="flex flex-col space-x-2"${_scopeId}><span class="flex space-x-2"${_scopeId}><h1 class="dark:text-slate-300 text-slate-400 text-xl font-bold line-through"${_scopeId}>${ssrInterpolate(unref(formatPrice)(__props.product.price))}</h1><span class="my-auto px-1 rounded bg-red-400 text-sm text-white font-semibold"${_scopeId}>-${ssrInterpolate(__props.product.sale)}%</span></span><h1 class="dark:text-slate-300 text-3xl font-bold"${_scopeId}>${ssrInterpolate(unref(formatPrice)((_b = __props.product) == null ? void 0 : _b.promotion_price))}</h1></span>`);
              }
...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductPage-684ff6f9.js
                                ...
                                createVNode("img", {
                                  src: image.image1,
========
                                class: [{ "border-gray-900": (image == null ? void 0 : image.image1) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"],
                                type: "button",
...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductPage-684ff6f9.js
                                ...
                                createVNode("img", {
                                  src: image.image2,
========
                                class: [{ "border-gray-900": (image == null ? void 0 : image.image2) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"],
                                type: "button",
...
========
                                class: [{ "border-gray-900": (image == null ? void 0 : image.image3) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"],
                                type: "button",
...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductPage-684ff6f9.js
                                ...
                                createVNode("img", {
                                  src: image.image4,
========
                                class: [{ "border-gray-900": (image == null ? void 0 : image.image4) === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"],
                                type: "button",
                      ...
                      createVNode("div", { class: "my-1 space-x-2 py-6 flex items-end" }, [
                        !__props.product.has_discount ? (openBlock(), createBlock("h1", {
                          ...
                          createVNode("span", { class: "flex space-x-2" }, [
                            createVNode("h1", { class: "dark:text-slate-300 text-slate-400 text-xl font-bold line-through" }, toDisplayString(unref(formatPrice)(__props.product.price)), 1),
                          ...
                          createVNode("h1", { class: "dark:text-slate-300 text-3xl font-bold" }, toDisplayString(unref(formatPrice)((_d = __props.product) == null ? void 0 : _d.promotion_price)), 1)
                        ])),
