...
import { u as useCartStore, a as useWishlistStore, _ as _sfc_main$1 } from "./FrontLayout-d389c584.js";
          ...
          if (_push2) {
            ...
            if (unref(cartStore).countCart > 0) {
              ...
              ssrRenderList(unref(cartStore).products, (product) => {
                _push2(`<div class="relative grid grid-cols-2 sm:grid-cols-6 gap-4 container-simple border bg-white dark:bg-1 rounded-md items-start p-4"${_scopeId}><div class="absolute right-2 top-2 group/remove"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" class="group-hover/remove:opacity-100 opacity-50 text-black group-hover:text-red-600 transition group-hover:ease-in-out duration-200 hover:scale-110" viewBox="0 0 24 24"${_scopeId}><g fill="none"${_scopeId}><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"${_scopeId}></path><path fill="currentColor" d="M14.28 2a2 2 0 0 1 1.897 1.368L16.72 5H20a1 1 0 1 1 0 2l-.003.071l-.867 12.143A3 3 0 0 1 16.138 22H7.862a3 3 0 0 1-2.992-2.786L4.003 7.07A1.01 1.01 0 0 1 4 7a1 1 0 0 1 0-2h3.28l.543-1.632A2 2 0 0 1 9.721 2zm3.717 5H6.003l.862 12.071a1 1 0 0 0 .997.929h8.276a1 1 0 0 0 .997-.929zM10 10a1 1 0 0 1 .993.883L11 11v5a1 1 0 0 1-1.993.117L9 16v-5a1 1 0 0 1 1-1m4 0a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0v-5a1 1 0 0 1 1-1m.28-6H9.72l-.333 1h5.226z"${_scopeId}></path></g></svg></div><div class="col-span-2 sm:col-span-1 mx-auto"${_scopeId}><img class="w-24"${ssrRenderAttr("src", product.image)} alt=""${_scopeId}></div><div class="col-span-2 sm:col-span-3 mx-auto sm:mx-0 my-auto"${_scopeId}><p${_scopeId}>${ssrInterpolate(product.name)}</p></div><div class="sm:col-span-1 my-auto"${_scopeId}><div class="w-fit border flex items-center px-2 rounded"${_scopeId}><span class="text-sm sm:text-xl cursor-pointer"${_scopeId}>-</span><input class="w-12 sm:w-18 md:w-20 xl:w-16 2xl:w-24 h-8 border-none" min="1" disabled style="${ssrRenderStyle({ "text-align": "center" })}"${ssrRenderAttr("value", product.qty)} type="number" name="" id=""${_scopeId}><span class="text-sm sm:text-xl cursor-pointer"${_scopeId}>+</span></div></div><div class="sm:col-span-1 text-right my-auto"${_scopeId}><p class="font-bold"${_scopeId}>${ssrInterpolate(product.total_price ?? product.price)} ${ssrInterpolate(_ctx.__("lei"))}</p></div></div>`);
              });
              _push2(`<!--]--></div><div class="container-simple border dark:bg-white rounded-md text-red p-4 lg:col-span-1"${_scopeId}><div class="grid grid-cols-1 gap-4"${_scopeId}><p class="font-bold"${_scopeId}>${ssrInterpolate(_ctx.__("order_details"))}</p><div${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
                value: _ctx.__("full_name")
              }, null, _parent2, _scopeId));
              _push2(`<input class="rounded-md w-full" type="text" name="first_name"${ssrRenderAttr("value", unref(form).full_name)} id="first_name"${_scopeId}>`);
              ...
              _push2(`<input class="rounded-md w-full" type="tel"${ssrRenderAttr("value", unref(form).phone)} name="phone" id="phone"${_scopeId}>`);
              ...
              _push2(`<input class="rounded-md w-full" type="email"${ssrRenderAttr("value", unref(form).email)} name="email" id="email"${_scopeId}>`);
              ...
              _push2(`<input class="rounded-md w-full" type="text"${ssrRenderAttr("value", unref(form).city)} name="city" id="city"${_scopeId}>`);
              ...
              _push2(`<input class="rounded-md w-full" type="search"${ssrRenderAttr("value", unref(form).address)} name="address" id="address"${_scopeId}>`);
              if (unref(form).errors.city) {
              ...
              _push2(`<textarea class="rounded-md w-full" name="message" id="message"${_scopeId}>${ssrInterpolate(unref(form).message)}</textarea>`);
                    ...
                    createVNode("div", { class: "container-simple border dark:bg-white rounded-md text-red p-4 lg:col-span-1" }, [
                      createVNode("div", { class: "grid grid-cols-1 gap-4" }, [
                        ...
                        createVNode("div", { class: "grid grid-cols-2 font-bold" }, [
                          createVNode("p", { class: "justify-self-start" }, "Subtotal:"),
                          createVNode("p", { class: "justify-self-end" }, toDisplayString(unref(cartStore).totalPrice) + " " + toDisplayString(_ctx.__("lei")), 1)
                        ]),
                        createVNode("div", { class: "grid grid-cols-2 font-bold" }, [
