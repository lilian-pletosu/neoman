...
import { _ as _sfc_main$2 } from "./FrontLayout-d389c584.js";
/* empty css                   */import { Carousel, Navigation, Slide } from "vue3-carousel";
import { Link } from "@inertiajs/vue3";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { _ as _sfc_main$3 } from "./ProductSection-06417f3b.js";
...
const CarouselFront_vue_vue_type_style_index_0_scoped_bf3651d9_lang = "";
const _sfc_main$1 = {
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img class="object-cover w-screen flex"${ssrRenderAttr("src", slide.image)}${ssrRenderAttr("alt", index)} data-v-bf3651d9${_scopeId3}>`);
                        } else {
                          return [
                            createVNode("img", {
...
const CarouselFront = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bf3651d9"]]);
const _sfc_main = {
  __name: "HomePage",
  __ssrInlineRender: true,
  props: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({
        ...
        carousel: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(CarouselFront, { images: ["/img/slider.png", "/img/slider2.png"] }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(CarouselFront, { images: ["/img/slider.png", "/img/slider2.png"] }, null, 8, ["images"])
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
