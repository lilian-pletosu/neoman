...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative grid grid-cols-1 gap-2 p-2 border 2xl:grid-cols-2 container-custom-rounded border-1 border-slate-300" }, _attrs))}><div class="flex flex-col col-span-1"><span>${ssrInterpolate(_ctx.__("installments"))}</span><input type="text"${ssrRenderAttr("value", formData.value.num_of_installments)} class="w-full rounded disabled:bg-slate-100 disabled:border-0"${ssrIncludeBooleanAttr(!edit.value) ? " disabled" : ""}></div><div class="flex flex-col col-span-1 pb-6"><span>${ssrInterpolate(_ctx.__("interest_rate"))}</span><input type="text"${ssrRenderAttr("value", formData.value.interest_rate)} class="w-full rounded disabled:bg-slate-100 disabled:border-0"${ssrIncludeBooleanAttr(!edit.value) ? " disabled" : ""}></div><div class="${ssrRenderClass([edit.value ? "" : "absolute", "flex col-span-2 gap-2 text-center right-1 bottom-1 j"])}">`);
      if (!edit.value) {
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Ești sigur ca vrei să ștergi?</p><button class="px-4 py-2 text-white bg-red-500"${_scopeId}> Delete </button>`);
          } else {
            return [
              createVNode("p", null, "Ești sigur ca vrei să ștergi?"),
              createVNode("button", {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(TrashIcon), { class: "absolute w-4 cursor-pointer right-1 top-1 text-slate-300 hover:text-red-300" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(unref(TrashIcon), { class: "absolute w-4 cursor-pointer right-1 top-1 text-slate-300 hover:text-red-300" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$4, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex flex-col mt-8"${_scopeId}><div class="overflow-x-auto rounded-lg"${_scopeId}><div class="flex-shrink-0"${_scopeId}><div class="flex flex-col mt-8"${_scopeId}><div class="p-2 overflow-x-auto rounded-lg"${_scopeId}><div class="grid grid-cols-1 gap-3 lg:grid-cols-2"${_scopeId}><section${_scopeId}><span class="text-lg font-medium"${_scopeId}>${ssrInterpolate(_ctx.__("credit_info"))}</span><div class="container-custom-rounded border border-1 border-slate-300 p-2 bg-slate-100/50 min-h-[150px]"${_scopeId}><div class="grid grid-cols-1 gap-2 md:grid-cols-3"${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></div></div></section><section${_scopeId}><span class="text-lg font-medium"${_scopeId}>${ssrInterpolate(_ctx.__("installments_info"))}</span><div class="container-custom-rounded border border-1 border-slate-300 p-2 bg-slate-100/50 min-h-[150px]"${_scopeId}><div class="grid grid-cols-1 gap-2 md:grid-cols-3"${_scopeId}><!--[-->`);
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col gap-4 p-4"${_scopeId2}><div class="flex justify-between"${_scopeId2}><h3 class="primary-text"${_scopeId2}>${ssrInterpolate(_ctx.__("add_new_credit"))}</h3></div><div class="grid grid-cols-1 gap-2 md:grid-cols-2"${_scopeId2}><div${_scopeId2}>`);
                  ...
                  _push3(ssrRenderComponent(unref(VSelect), {
                    options: __props.products,
                    label: "name",
                    multiple: "",
                    modelValue: unref(form).products,
                    "onUpdate:modelValue": ($event) => unref(form).products = $event
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div class="col-span-2 p-2 border"${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(form).products, (product) => {
                    _push3(`<p${_scopeId2}> - ${ssrInterpolate(product.name)}</p>`);
                  });
                  _push3(`<!--]--></div></div><div class="flex justify-end mt-6"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "flex flex-col gap-4 p-4" }, [
                      ...
                      createVNode("div", { class: "grid grid-cols-1 gap-2 md:grid-cols-2" }, [
                        ...
                        createVNode("div", { class: "col-span-2 p-2 border" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(form).products, (product) => {
                            return openBlock(), createBlock("p", null, " - " + toDisplayString(product.name), 1);
                          }), 256))
                        ])
                      ]),
                ...
                createVNode("div", { class: "container-rounded" }, [
                  ...
                  createVNode("div", { class: "flex flex-col mt-8" }, [
                    createVNode("div", { class: "overflow-x-auto rounded-lg" }, [
                      createVNode("div", { class: "flex-shrink-0" }, [
                        createVNode("div", { class: "flex flex-col mt-8" }, [
                          createVNode("div", { class: "p-2 overflow-x-auto rounded-lg" }, [
                            createVNode("div", { class: "grid grid-cols-1 gap-3 lg:grid-cols-2" }, [
                              createVNode("section", null, [
                                createVNode("span", { class: "text-lg font-medium" }, toDisplayString(_ctx.__("credit_info")), 1),
                              ...
                              createVNode("section", null, [
                                createVNode("span", { class: "text-lg font-medium" }, toDisplayString(_ctx.__("installments_info")), 1),
                                createVNode("div", { class: "container-custom-rounded border border-1 border-slate-300 p-2 bg-slate-100/50 min-h-[150px]" }, [
                                  createVNode("div", { class: "grid grid-cols-1 gap-2 md:grid-cols-3" }, [
