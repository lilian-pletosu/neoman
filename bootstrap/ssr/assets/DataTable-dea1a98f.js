...
const DataTable_vue_vue_type_style_index_0_scoped_1d1c00db_lang = "";
const _sfc_main = {
  __name: "DataTable",
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="flex mb-4" data-v-1d1c00db><div class="flex lg:w-1/2 xl:w-4/12 relative" data-v-1d1c00db><input type="text" id="search"${ssrRenderAttr("value", unref(searchText))}${ssrRenderAttr("aria-label", _ctx.__("search"))}${ssrRenderAttr("placeholder", _ctx.__("search..."))} class="block flex rounded-md border-gray-300 shadow-sm focus:border-teal-500 flex-auto pr-10" data-v-1d1c00db>`);
      ...
      _push(`</div><div class="flex" data-v-1d1c00db>`);
      ...
      _push(`</div></div><div class="flex flex-col mt-8" data-v-1d1c00db><div class="overflow-x-auto md:overflow-hidden flex rounded-lg" data-v-1d1c00db><div class="align-middle inline-block w-full" data-v-1d1c00db><div class="shadow overflow-hidden sm:rounded-lg" data-v-1d1c00db><table class="w-full divide-y divide-gray-200" data-v-1d1c00db><thead class="bg-gray-50" data-v-1d1c00db><tr data-v-1d1c00db><!--[-->`);
      ssrRenderList(__props.columnsOrder, (column) => {
        _push(`<th scope="col" class="${ssrRenderClass([{ "hidden xl:block": column === "description" }, "p-4 text-xs font-medium text-gray-500 uppercase tracking-wider flex-1"])}" data-v-1d1c00db>${ssrInterpolate(_ctx.__(column))}</th>`);
      });
      _push(`<!--]--></tr></thead><tbody class="bg-white" data-v-1d1c00db><!--[-->`);
      ssrRenderList(__props.resources.data, (resource, index) => {
        _push(`<tr class="hover:bg-gray-100 w-full" data-v-1d1c00db><!--[-->`);
        ssrRenderList(__props.columnsOrder, (columnInOrder) => {
          _push(`<!--[--><!--[-->`);
          ssrRenderList(__props.columns, (column) => {
            _push(`<!--[-->`);
            if (column === columnInOrder) {
              _push(`<td class="${ssrRenderClass([{ "hidden xl:block": columnInOrder === "description" }, "py-2 px-6 text-sm text-gray-900 whitespace-wrap"])}" data-v-1d1c00db>`);
              if (columnInOrder === "image") {
                _push(`<!--[-->`);
                if (resource[columnInOrder] && resource[columnInOrder] !== "image") {
                  _push(`<img class="w-16 mx-auto"${ssrRenderAttr("src", resource[columnInOrder])} alt="image if" data-v-1d1c00db>`);
                } else if (resource[columnInOrder]) {
                  _push(`<img class="w-16 mx-auto"${ssrRenderAttr("src", "/img/no_image.svg")} alt="image else" data-v-1d1c00db>`);
                } else {
                  _push(`<!---->`);
                }
                _push(`<!--]-->`);
              } else if (column === "website") {
                _push(`<div class="rounded flex justify-center" data-v-1d1c00db><a rel="stylesheet" title="sds"${ssrRenderAttr("href", `http://${resource[columnInOrder]}`)} data-v-1d1c00db>${ssrInterpolate(resource[columnInOrder])}</a></div>`);
              } else if (column === "type") {
                _push(`<!--[-->`);
                if (resource[columnInOrder] === "fast_order") {
                  _push(ssrRenderComponent(unref(BoltIcon), { class: "text-yellow-400 p-1 mx-auto" }, null, _parent));
                } else {
                  _push(`<!---->`);
                }
                if (resource[columnInOrder] === "credit") {
                  _push(ssrRenderComponent(unref(ReceiptPercentIcon), { class: "text-red-400 p-1 mx-auto" }, null, _parent));
                } else {
                  _push(`<!---->`);
                }
                if (resource[columnInOrder] === "simple") {
                  _push(ssrRenderComponent(unref(CheckBadgeIcon), { class: "text-blue-400 p-1 mx-auto" }, null, _parent));
                } else {
                  _push(`<!---->`);
                }
                if (resource[columnInOrder] === "installments") {
                  _push(ssrRenderComponent(unref(VariableIcon), { class: "text-red-400 p-1 mx-auto" }, null, _parent));
                } else {
                  _push(`<!---->`);
                }
                _push(`<!--]-->`);
                ...
                }, "rounded p-1 text-center text-black shadow mx-auto"])}" data-v-1d1c00db>${ssrInterpolate(_ctx.__(applyFormat(column, resource[columnInOrder])) ?? "--")}</div>`);
          ...
          if (_ctx.$page.props.relationColumns) {
            ...
            ssrRenderList(_ctx.$page.props.relationColumns, (relationColumn) => {
              ...
              if (relationColumn.label === columnInOrder) {
                _push(`<td class="py-2 px-6 text-sm text-gray-900 whitespace-nowrap hover text-center first-letter:uppercase" data-v-1d1c00db>${ssrInterpolate(((_a = resource[relationColumn.relation]) == null ? void 0 : _a.name) ?? "---")}</td>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
      ...
      _push(`<!--]--></tbody></table></div><div class="flex place-content-start mt-4" data-v-1d1c00db>`);
...
const DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1d1c00db"]]);
export {
  DataTable as D
};
