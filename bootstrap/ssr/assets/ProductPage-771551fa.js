...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSlot, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
import { u as useCartStore, a as useWishlistStore, _ as _sfc_main$3, b as _sfc_main$4 } from "./FrontLayout-d389c584.js";
import { Link, router } from "@inertiajs/vue3";
import { route } from "ziggy-js";
import { _ as _sfc_main$5 } from "./ProductSection-06417f3b.js";
...
import "swiper/vue";
import "@heroicons/vue/16/solid/index.js";
const _sfc_main$2 = {
  __name: "Breadcrumb",
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></li><li><div class="flex items-center"><svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path></svg><a${ssrRenderAttr("href", unref(route)("products_page", { subSubcategory: __props.product.sub_sub_category.slug }))} class="ms-1 text-xs font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">${ssrInterpolate(_ctx.__(__props.product.sub_sub_category.name))}</a></div></li><li aria-current="page"><div class="flex items-center"><svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path></svg><span class="ms-1 font-medium text-xs text-blue-500 md:ms-2 dark:text-gray-400">${ssrInterpolate(__props.product.name)}</span></div></li></ol></nav></div>`);
    };
  }
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    function openImage() {
      ...
      filteredImages.value = Object.values(images.value).filter(
        (image) => typeof image === "string" && image.startsWith("/storage/products/")
      );
    }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (Object.keys(__props.product)) {
              _push2(`<section class="py-12 mt-1 sm:py-16"${_scopeId}><div class=""${_scopeId}><div class="lg:col-gap-12 xl:col-gap-16 grid grid-cols-1 gap-12 lg:-mt-12 lg:grid-cols-5 lg:gap-16"${_scopeId}><div class="lg:col-span-3 lg:row-end-1"${_scopeId}><div class="lg:flex"${_scopeId}><div class="lg:order-2 lg:ml-5 flex-1"${_scopeId}><div class="overflow-hidden w-full h-[300px] md:h-[500px] rounded-lg"${_scopeId}><img class="object-contain w-full h-[300px] md:h-[500px] cursor-pointer"${ssrRenderAttr("src", selectedImage.value)} alt=""${_scopeId}></div></div><div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0"${_scopeId}><!--[-->`);
              ssrRenderList(__props.product.images, (image, index) => {
                _push2(`<div class="flex flex-row items-start lg:flex-col"${_scopeId}><button style="${ssrRenderStyle(image.image1 != null ? null : { display: "none" })}" type="button" class="${ssrRenderClass([{ "border-gray-900": image.image1 === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}"${_scopeId}><img class="h-full w-full object-cover"${ssrRenderAttr("src", image.image1)} alt=""${_scopeId}></button><button style="${ssrRenderStyle(image.image2 != null ? null : { display: "none" })}" type="button" class="${ssrRenderClass([{ "border-gray-900": image.image2 === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}"${_scopeId}><img class="h-full w-full object-cover"${ssrRenderAttr("src", image.image2)} alt=""${_scopeId}></button><button style="${ssrRenderStyle(image.image3 != null ? null : { display: "none" })}" type="button" class="${ssrRenderClass([{ "border-gray-900": image.image3 === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}"${_scopeId}><img class="h-full w-full object-cover"${ssrRenderAttr("src", image.image3)} alt=""${_scopeId}></button><button style="${ssrRenderStyle(image.image4 != null ? null : { display: "none" })}" type="button" class="${ssrRenderClass([{ "border-gray-900": image.image4 === selectedImage.value }, "flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 text-center"])}"${_scopeId}><img class="h-full w-full object-cover"${ssrRenderAttr("src", image.image4)} alt=""${_scopeId}></button></div>`);
              });
              _push2(`<!--]--></div></div></div><div class="lg:col-span-2 lg:row-span-2 lg:row-end-2"${_scopeId}><div class="flex items-start"${_scopeId}><h1 class="dark:text-slate-300 text-2xl font-bold text-gray-900 sm:text-3xl"${_scopeId}>${ssrInterpolate(__props.product.name)}</h1><button type="button" class="rounded-md border border-slate-500 bg-none px-2 py-2 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(HeartIcon), {
                class: ["w-6", unref(wishlistStore).checkIfProductExistInWishlist(__props.product.id) ? "text-red-500 fill-red-500" : "text-slate-700 dark:text-slate-300"]
              }, null, _parent2, _scopeId));
              _push2(`</button></div><div class="mt-2 flex justify-between items-center"${_scopeId}><img class="w-16"${ssrRenderAttr("src", __props.product.brand.image)} alt=""${_scopeId}><div class="flex items-center dark:text-slate-300"${_scopeId}><div class="flex items-center"${_scopeId}>${ssrInterpolate(_ctx.__("product_code"))}: </div><p class="ml-2 text-sm font-medium text-gray-500"${_scopeId}>${ssrInterpolate(__props.product.product_code)}</p></div></div><!--[-->`);
              ssrRenderList(__props.product.attributes, (attribute, key) => {
                ...
                if (["cantitate", "Cantitate'"].includes(key) && attribute.values.length > 1) {
                  ...
                  ssrRenderList(attribute.values, (value, index) => {
                    _push2(`<option class="dark:bg-slate-600" selected${ssrRenderAttr("value", value.link)}${_scopeId}>${ssrInterpolate(value.value)} ${ssrInterpolate(value.mu)}</option>`);
                  });
              ...
              _push2(`<!--]--><div class="my-1 space-x-2 py-6 flex items-end"${_scopeId}><h1 class="dark:text-slate-300 text-3xl font-bold"${_scopeId}>${ssrInterpolate(__props.product.price.toFixed(2))}</h1><h1 class="dark:text-white text-2xl font-medium"${_scopeId}>${ssrInterpolate(_ctx.__("lei"))}</h1><h1 class="text-xl text-slate-500 font-light"${_scopeId}> / ${ssrInterpolate(__props.product.mu)}</h1></div><div${_scopeId}><div class="container-custom-rounded dark:bg-slate-800 mb-4 flex items-center space-x-4 p-2 border border-[#1FC8F3] cursor-pointer"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="dark:text-slate-300 bi bi-question-circle" viewBox="0 0 16 16"${_scopeId}><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"${_scopeId}></path><path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286m1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94"${_scopeId}></path></svg><p class="dark:text-slate-300 text-lg flex font-light"${_scopeId}>${ssrInterpolate(_ctx.__("found_cheaper"))}</p></div></div><div class="flex flex-col space-y-2 border-t border-b dark:border-y-slate-600 py-4 sm:flex-row sm:space-x-2 sm:space-y-0"${_scopeId}><button class="w-full sm:w-1/4 inline-flex items-center justify-center rounded-md border-2 border-transparent bg-primary-blue bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-primary-blue-200" type="button"${_scopeId}>${ssrInterpolate(_ctx.__("buy"))}</button><button type="button" class="w-full inline-flex items-center justify-center rounded-md border-2 border-transparent bg-1 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800"${_scopeId}>${ssrInterpolate(_ctx.__("buy_1_click"))}</button></div><div${_scopeId}><button type="button" class="w-full inline-flex items-center justify-center rounded-md border-2 border-transparent bg-slate-500 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-slate-600"${_scopeId}>${ssrInterpolate(_ctx.__("buy_in_credit"))}</button></div><div class="container-custom-rounded dark:bg-slate-800 mt-4 flex items-center space-x-4 w-full p-3 border border-slate-400"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 32 32" class="dark:text-slate-300"${_scopeId}><path fill="currentColor" d="M4 16h12v2H4zm-2-5h10v2H2z"${_scopeId}></path><path fill="currentColor" d="m29.919 16.606l-3-7A.999.999 0 0 0 26 9h-3V7a1 1 0 0 0-1-1H6v2h15v12.556A3.992 3.992 0 0 0 19.142 23h-6.284a4 4 0 1 0 0 2h6.284a3.98 3.98 0 0 0 7.716 0H29a1 1 0 0 0 1-1v-7a.997.997 0 0 0-.081-.394M9 26a2 2 0 1 1 2-2a2.002 2.002 0 0 1-2 2m14-15h2.34l2.144 5H23Zm0 15a2 2 0 1 1 2-2a2.002 2.002 0 0 1-2 2m5-3h-1.142A3.995 3.995 0 0 0 23 20v-2h5Z"${_scopeId}></path></svg><div class="dark:text-slate-300 flex items-center flex-col text-center"${_scopeId}><p class="text-lg flex font-medium"${_scopeId}>${ssrInterpolate(_ctx.__("delivery_info"))}</p><p class="text-sm underline flex font-light"${_scopeId}>${ssrInterpolate(_ctx.__("delivery_aditional_info"))}</p></div></div></div><div class="lg:col-span-3"${_scopeId}><div class="border-b border-gray-300 dark:border-slate-500"${_scopeId}><nav class="flex gap-4"${_scopeId}><a href="#" title="specifications" class="${ssrRenderClass([{ "transition delay-150 border-b-2 border-gray-500": specifications.value, "border-transparent": !specifications.value }, "dark:text-slate-300 py-4 text-sm font-medium text-gray-900 hover:border-gray-400 hover:text-gray-800"])}"${_scopeId}>${ssrInterpolate(_ctx.__("specifications"))}</a><a href="#" title="description" class="${ssrRenderClass([{ "transition delay-150 border-b-2 border-gray-500": description.value, "border-transparent": !description.value }, "dark:text-slate-300 py-4 text-sm font-medium text-gray-900 hover:border-gray-400 hover:text-gray-800"])}"${_scopeId}>${ssrInterpolate(_ctx.__("description"))}</a></nav></div><div style="${ssrRenderStyle(description.value ? null : { display: "none" })}" id="description" class="mt-8 flow-root sm:mt-12"${_scopeId}><h1 class="text-3xl font-bold dark:text-slate-300"${_scopeId}>${ssrInterpolate(__props.product.name)}</h1><p class="mt-4 dark:text-slate-300"${_scopeId}>${ssrInterpolate(__props.product.description)}</p></div><div style="${ssrRenderStyle(specifications.value ? null : { display: "none" })}" class="mt-8 flow-root sm:mt-2"${_scopeId}><div class="relative overflow-x-auto my-4"${_scopeId}><table class="w-full border dark:border-slate-600 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 bg-red-200"${_scopeId}><tbody${_scopeId}><!--[-->`);
              ssrRenderList(__props.product.attributes, (attribute, key) => {
                      ...
                      if (_push4) {
                        ...
                        ssrRenderList(filteredImages.value, (slide, index) => {
                          _push4(ssrRenderComponent(unref(Slide), { key: index }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<img class="object-contain w-full h-[120vw] sm:h-[40vw]"${ssrRenderAttr("src", slide)}${ssrRenderAttr("alt", index)}${_scopeId4}>`);
                              } else {
                                return [
                                  createVNode("img", {
            ...
            return [
              ...
              Object.keys(__props.product) ? (openBlock(), createBlock("section", {
                  ...
                  createVNode("div", { class: "lg:col-gap-12 xl:col-gap-16 grid grid-cols-1 gap-12 lg:-mt-12 lg:grid-cols-5 lg:gap-16" }, [
                    ...
                    createVNode("div", { class: "lg:col-span-2 lg:row-span-2 lg:row-end-2" }, [
                      ...
                      createVNode("div", { class: "my-1 space-x-2 py-6 flex items-end" }, [
                        createVNode("h1", { class: "dark:text-slate-300 text-3xl font-bold" }, toDisplayString(__props.product.price.toFixed(2)), 1),
                        createVNode("h1", { class: "dark:text-white text-2xl font-medium" }, toDisplayString(_ctx.__("lei")), 1),
                        createVNode("h1", { class: "text-xl text-slate-500 font-light" }, " / " + toDisplayString(__props.product.mu), 1)
                      ]),
                ...
                createVNode(_sfc_main$4, {
                  ...
                  product: __props.product,
                  onSelect: ($event) => console.log($event)
                }, null, 8, ["title", "type", "onClose", "visible", "product", "onSelect"])
              ])) : createCommentVNode("", true),
              createVNode("hr"),
