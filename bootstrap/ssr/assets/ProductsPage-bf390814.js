...
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductsPage-025f2738.js
import { u as useCartStore, a as useWishlistStore, _ as _sfc_main$1, c as _sfc_main$2 } from "./FrontLayout-fec85b0a.js";
========
import { u as useCartStore, a as useWishlistStore, _ as _sfc_main$1, c as _sfc_main$2, f as formatPrice } from "./FrontLayout-2d8a94b7.js";
>>>>>>>> origin/master:bootstrap/ssr/assets/ProductsPage-bf390814.js
                    ...
                    _push3(ssrRenderComponent(unref(DisclosurePanel), { class: "pt-6" }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          ssrRenderList(attribute.options, (option) => {
<<<<<<<< HEAD:bootstrap/ssr/assets/ProductsPage-025f2738.js
                            _push4(`<div class="flex items-center"${_scopeId3}><input${ssrIncludeBooleanAttr(isOptionSelected(attribute.key, option.id)) ? " checked" : ""}${ssrRenderAttr("name", option.value)}${ssrRenderAttr("value", option.id)} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" type="checkbox"${_scopeId3}><label${ssrRenderAttr("for", option.value)} class="ml-3 text-sm text-gray-600 first-letter:uppercase"${_scopeId3}>${ssrInterpolate(option.value)}</label></div>`);
========
