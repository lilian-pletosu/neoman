...
import { _ as _sfc_main$1 } from "./FrontLayout-d389c584.js";
import { _ as _sfc_main$2 } from "./ProductSection-06417f3b.js";
            ...
            ssrRenderList(__props.category.subcategory, (subcategory) => {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="h-28"${_scopeId2}><div class="absolute bg-cover -top-20 lg:top-[-10%] left-[5%] group-hover:top-[-40%] group-hover:opacity-[0.9] duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle"${_scopeId2}><img${ssrRenderAttr("src", subcategory.image)} class="w-80 h-44 mt-6 m-auto mix-blend-multiply" alt="Automotive" title="Automotive" loading="lazy" width="200" height="200"${_scopeId2}></div></div><div class="p-6 w-full"${_scopeId2}><p class="mb-2 text-tg text-center w-full text-xl font-sans hidden group-hover:inline-block font-semibold leading-snug tracking-normal antialiased"${_scopeId2}>${ssrInterpolate(subcategory.name)}</p></div>`);
                  } else {
                    return [
                      ...
                      createVNode("div", { class: "p-6 w-full" }, [
                        createVNode("p", { class: "mb-2 text-tg text-center w-full text-xl font-sans hidden group-hover:inline-block font-semibold leading-snug tracking-normal antialiased" }, toDisplayString(subcategory.name), 1)
                      ])
                    ];
                  }
                }),
