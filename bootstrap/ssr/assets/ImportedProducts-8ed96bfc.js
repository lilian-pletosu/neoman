...
import { _ as _sfc_main$2, t as toast } from "./AdminLayout-d40237f3.js";
          ...
          if (_push2) {
            ...
            if (__props.resources.data.length !== 0) {
              ...
              ssrRenderList(__props.resources.data, (resource, key) => {
                var _a, _b, _c;
                _push2(`<tr${_scopeId}><td class="sticky inset-y-0 start-0 bg-white px-4 py-2"${_scopeId}><input id="Row1"${ssrIncludeBooleanAttr(isSelected(resource)) ? " checked" : ""} class="size-5 rounded border-gray-300" type="checkbox"${_scopeId}></td><td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 cursor-default"${_scopeId}><img${ssrRenderAttr("src", (_a = resource.images) == null ? void 0 : _a.image1)} alt="no" class="w-10 h-10"${_scopeId}></td><td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 cursor-default"${_scopeId}>${ssrInterpolate(resource.name.ro)}</td><td class="whitespace-nowrap px-4 py-2 text-gray-700"${_scopeId}>${ssrInterpolate((_b = resource.sub_sub_category) == null ? void 0 : _b.name)}</td><td class="whitespace-nowrap px-4 py-2 text-gray-700"${_scopeId}>${ssrInterpolate((_c = resource.brand) == null ? void 0 : _c.name)}</td><td class="whitespace-nowrap px-4 py-2 text-gray-700"${_scopeId}>${ssrInterpolate(resource.price)}</td></tr>`);
              });
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.resources.data, (resource, key) => {
                              ...
                              return openBlock(), createBlock("tr", { key }, [
                                ...
                                createVNode("td", {
                                  ...
                                  createVNode("img", {
                                    src: (_a = resource.images) == null ? void 0 : _a.image1,
                                    alt: "no",
                                    class: "w-10 h-10"
                                  }, null, 8, ["src"])
                                ], 8, ["onClick"]),
