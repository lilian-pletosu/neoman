<template>
    <admin-layout :current-route="$page.props.initialRoute" title="Privacy">
        <div class="w-full grid grid-cols-1  gap-4">
            <div class="container-rounded ">

                <div class="mb-4 flex items-center justify-between">
                    <div>
                        <h3 class="primary-text">{{ __('privacy') }}</h3>
                ...
                <div>
                    <h2 class="flex justify-center" v-if="resources.data.length === 0">{{ __('no_privacy') }}...</h2>
                </div>
