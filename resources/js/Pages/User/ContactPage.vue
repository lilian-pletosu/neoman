        ...
        <div class="py-4">
            ...
            <section class="">
                <div class="px-4 pb-4 mx-auto sm:px-6 lg:px-8">
                    <div
                        class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5 dark:text-white"
                    >
                        <div class="lg:col-span-2 lg:py-12">
                            <p
                                class="max-w-xl text-lg font-semibold font-mulish"
                            >
                                {{ __("your_opinion_counts_for_us") }}
                            </p>
                            <hr class="py-2" />
                            <span
                                class="max-w-xl text-lg font-light font-mulish"
                                >{{ __("write_us") }}</span
                            >
                            ...
                            <div class="mt-8">
                                ...
                                <address class="mt-2 not-italic">
                                    str.Varnita Chisinau, MD-2023, Strada
                                    Uzinelor 12a, Chișinău, Chisinau, Moldova
                                </address>
                            </div>
                        </div>

                        <div
                            class="p-8 bg-white rounded-lg shadow lg:col-span-3 lg:p-12 border-1 border-slate-600"
                        >
                            <form
                                v-if="!showSuccess"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        class="py-1 text-red-600"
                                        v-if="form.errors.option"
                                        >{{ __(form.errors.option) }}*</span
                                    >
                                </div>
