...
<template>
    <front-layout title="Pagina principală">
        ...
        <section v-if="Object.keys(product)" class="py-12 mt-1 sm:py-16">
            <div class="">
                <div
                    class="grid grid-cols-1 gap-12 lg:col-gap-12 xl:col-gap-16 lg:-mt-12 lg:grid-cols-5 lg:gap-16"
                >
                    <div class="lg:col-span-3 lg:row-end-1">
                        <div class="lg:flex">
                            ...
                            <div
                                class="w-full mt-2 lg:order-1 lg:w-32 lg:flex-shrink-0"
                            >
                                <div
                    ...
                    <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        ...
                        <div
                            v-for="(attribute, key) in product.attributes"
                            class="border-t"
                        >
                            <div
                                v-if="
                            ...
                            >
                                <h2
                                    class="my-2 text-base text-gray-900 dark:text-slate-300 sm:my-6"
                                >
                                    {{ attribute.name }}:
                                </h2>
                                <div
                                    class="flex flex-wrap items-center gap-1 select-none 2xs:my-3"
                                >
                                    <select
                                        id="color"
                                        v-model="selectedQty"
                        ...
                        <div class="flex items-end py-6 my-1 space-x-2">
                            ...
                            <span v-else class="flex flex-col space-x-2">
                                <span class="flex space-x-2">
                                    <h1
                                        class="text-xl font-bold line-through dark:text-slate-300 text-slate-400"
                                    >
                                        {{ formatPrice(product.price) }}
                                    </h1>
                                    <span
                        ...
                        <div>
                            ...
                            >
                                ...
                                <p
                                    class="flex text-lg font-light dark:text-slate-300"
                                >
                                    {{ __("found_cheaper") }}
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <div
                                class="flex flex-col items-center text-center dark:text-slate-300"
                            >
                    ...
                    <div class="lg:col-span-3">
                        <div
                            class="border-b border-gray-300 dark:border-slate-500"
                        >
                            <nav class="flex gap-4">
                                ...
                                <a
                                    ...
                                    href="#"
                                    title="description"
                                    @click.prevent="setActiveTab('description')"
                                >
                                    {{ __("description") }}
                                </a>
                            </nav>
        ...
        >
            <template v-slot:content>
                <div class="w-full">
                    ...
                    >
                        <slide
                            v-for="(slide, index) in filteredImages"
                            :key="index"
                        >
                            <img
                                :alt="index"
