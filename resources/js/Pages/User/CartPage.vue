            ...
            <section class="pt-4">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <div v-for="product in cartStore.products" :key="product.id"
                            ...
                            <div class="col-span-2 sm:col-span-1    mx-auto ">
                                <img :src="product.image" alt="" class="w-24 h-24  object-contain mx-auto">
                            </div>
                        ...
                        <form @submit.prevent="checkout()">
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input id="first_name" v-model="form.full_name"
                                           class="rounded-md w-full"
                                           name="first_name"
                                           type="text">
                                    <span v-if="form.errors.full_name"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.full_name) }}</span>
                                </div>
                                <div>
                                    ...
                                    <input id="phone" v-model="form.phone"
                                           ...
                                           name="phone"
                                           type="tel">
                                    <span v-if="form.errors.phone"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.phone) }}</span>
                                </div>
                                <div>
                                    ...
                                    <span v-if="form.errors.email"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.email) }}</span>
                                </div>
                                <div>
                                    ...
                                    <input id="city" v-model="form.city"
                                           ...
                                           name="city"
                                           type="text">
                                    <span v-if="form.errors.city"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.city) }}</span>
                                </div>
                                <div>
                                    ...
                                    <input id="address" v-model="form.address"
                                           ...
                                           type="search">
                                    <span v-if="form.errors.city"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.address) }}</span>
                                </div>
                                <div>
                                    ...
                                    <span v-if="form.errors.message"
                                          class="font-light text-xs text-red-500">{{ __(form.errors.message) }}</span>
                                </div>
                ...
                <div v-else class="p-2 mx-auto flex flex-col justify-center items-center space-y-6 py-12">
                    <div class="w-fit rounded-full p-8 bg-[#F1F5F9] border border-[#CBD5E1] ">
                        <svg class="bi bi-cart3" fill="currentColor" height="2em" viewBox="0 0 16 16"
                    ...
                    <div v-if="!loading" class="bg-white p-6  md:mx-auto">
                        ...
                        <div class="text-center">
                            ...
                            <div class="py-10 text-center">
                                <p class="px-12 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3 cursor-pointer rounded-md"
