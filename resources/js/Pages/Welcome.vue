...
<template>
    <div class="antialiased max-h-screen bg-cover bg-no-repeat" >

    <div class="bg-gradient-to-r m-4" >
        <img class="w-40 h-auto" src="img/neo_logo_new.png" alt="neoman.md">
    </div>
 ...
 <style>
 body {
     background-image: url('/img/background_welcome.webp');
