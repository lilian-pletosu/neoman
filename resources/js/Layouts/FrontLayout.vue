...
<template>
            ...
            <div class="flex flex-col w-full min-h-screen">
                ...
                <div id="main-content" class="justify-between flex-1">
                    <main class="">
                        ...
                        <brands-list v-if="$page.props.ziggy.location === route('home')" :brands="app.appContext.config.globalProperties.$page
                            .props.brands
                            " />
                        <!--                    main content -->
                        <article>
                        ...
                        <div data-dial-init class="fixed block z-100 end-6 bottom-6 group">
                            <a href="https://www.facebook.com/messages/t/110912380742445" type="button"
                                ...
                                <svg class="animate-pulse" xmlns="http://www.w3.org/2000/svg" width="200" height="200"
                                    viewBox="0 0 256 256">
                                    <defs>
                                        <radialGradient id="logosMessenger0" cx="19.247%" cy="99.465%" r="108.96%"
                                            fx="19.247%" fy="99.465%">
                        ...
                        <front-modal :title="__('return_with_call')" :visible="isModalVisible" @close="closeModal"
                            :type="call" @call="(args) => waitCall(args)" />
    ...
    <template v-else>
        <!-- component -->
        <div class="fixed inset-0 flex items-center justify-center w-full h-full transition-opacity duration-300 bg-gray-800"
            style="z-index: 6000">
            <div class="flex-col">
                <x-loading class="w-24 h-24">
                    <svg viewBox="0 0 860.1 876.5">
                        <path class="animate-spin from-blue-300" style="
                                stroke: black;
                                stroke-width: 1;
                        ...
                        <path class="animate-spin from-pink-300" style="
                                stroke: black;
                                stroke-width: 1;
                        ...
                        <path class="animate-spin from-yellow-300" style="
                                stroke: black;
                                stroke-width: 1;
