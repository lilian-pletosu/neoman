...
<template>
    <template v-if="!isLoading">
        <body class="overflow-x-hidden dark:bg-dark">
            <Head :title="title">
                <meta charset="UTF-8" />
                <meta
                    name="viewport"
            ...
            <div class="flex flex-col w-full min-h-screen">
                ...
                <div id="main-content" class="justify-between flex-1">
                    <main class="">
                        <Toaster
                            title="Success"
                            :message="cartStore.message"
                            :show="true"
                        ...
                        <brands-list
                            v-if="$page.props.ziggy.location === route('home')"
                            :brands="
                                app.appContext.config.globalProperties.$page
                                    .props.brands
                            "
                        />
                        <!--                    main content -->
                        ...
                        <div
                            data-dial-init
                            class="fixed hidden md:block end-6 bottom-6 group"
                        >
                            <div
    ...
    <template v-else>
        ...
        >
            <div class="flex-col">
                ...
                <div class="mt-3 font-mono text-sm text-gray-200 sm:text-xs">
                    Loading...
                </div>
            </div>
        </div>
