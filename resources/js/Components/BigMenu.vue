                            ...
                            <DropdownMenuSubContent
                                ...
                                <div class="columns-3 ">
                                    <div v-for="subcategory in category.subcategory"
                                        ...
                                        <DropdownMenuSub>
                                            <div class="flex items-center group/submenu">
                                            <span class="invisible group-hover/submenu:visible">
                                                <Icon
                                                    icon="mingcute:right-line" width="16" height="16"/>
                                            </span>
                                                <p class="font-bold"
                                                   @click="router.get(route('subcategory_page', {slug: subcategory.slug}))">
                                                    {{ subcategory.name }}</p>
                                            ...
                                            <DropdownMenuItem
                                                ...
                                                class="group text-[13px] py-4 leading-none text-grass11 rounded-[3px] flex
                                            items-center h-[25px]  relative  "
                                                @click="router.get(route('products_page', {subSubcategory: sub_subcategory.slug}))">
                                                <div class="flex  items-center group/subsubmenu">
                                                <span class="invisible group-hover/subsubmenu:visible"><Icon
                                                    icon="mingcute:right-line" width="16" height="16"/></span>
                                                    <p class="w-[300px] text-base group-hover/subsubmenu:font-medium">
                                                        {{ sub_subcategory.name }}</p>
                                                </div>
                                            </DropdownMenuItem>
                                        </DropdownMenuSub>
                                    </div>
