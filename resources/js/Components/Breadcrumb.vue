            ...
            <ol class="flex flex-wrap space-x-1 md:space-x-0.5 rtl:space-x-reverse ">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <Link :href="route('category_page', {slug: product.sub_sub_category.subcategory.category.slug})"
                              class="ms-1 text-xs font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            {{
                                __(product.sub_sub_category.subcategory.category.name)
                            }}
                        </Link>
                    </div>
                </li>
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <Link :href="route('products_page', {subSubcategory: product.sub_sub_category.slug})"
                              class="ms-1 text-xs font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
                            {{
                                __(product.sub_sub_category.name)
                            }}
                        </Link>
                    </div>
                </li>
