...
<template>
    <div
        class="relative grid grid-cols-1 2xl:grid-cols-2 gap-4 container-custom-rounded p-2 border border-1 border-slate-300">
        <TrashIcon @click="removeCredit"
        ...
        <div class="right-1 bottom-1 flex j col-span-2 text-center gap-2" :class="edit ? '' : 'absolute'">
            <PencilSquareIcon v-if="!edit" @click="edit = !edit" class="w-5  cursor-pointer"/>
