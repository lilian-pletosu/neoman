...
p .swiper-button-prev.swiper-button-disabled,
...
<template>
    <div class="py-12 mb-6 space-y-6">
                    ...
                    <svg class="dark:text-white" height="2em" viewBox="0 0 24 24" width="2em"
                        ...
                        <g fill="none" stroke="currentColor">
                            <path
                                ...
                                stroke-width="2" />
                            <path d="M9.5 9.5h.01v.01H9.5zm5 5h.01v.01h-.01z" stroke-linejoin="round"
                                stroke-width="3" />
        ...
        }" :modules="modules" :navigation="true" :slidesPerView="1" :spaceBetween="20" class="relative"
            direction="horizontal">
            <swiper-slide v-for="(product, key) in products" class="p-2">
                <div
                    class="container-rounded flex items-center justify-center bg-white border border-slate-100 dark:bg-slate-100 w-96 h-[100px] xs:h-[350px] 1xs:h-[430px] 2xs:h-80 3xs:h-96 md:h-[380px] 2xl:h-[450px] 3xl:h-[450px] relative group/card">
                    {{ product.credit }}
                    <div v-if="product?.credits?.length > 0"
                    ...
                    <div class="hover:cursor-pointer">
                        <div>
                            <div class="static">
                                <div class="absolute z-10 w-12 left-2 top-2">
                                    <img loading="lazy" :alt="product.brand.name" :src="product.brand.image"
                        ...
                        <div class="relative mt-3" style="margin-bottom: 5vh">
                            <p class="text-xs font-bold text-black font-mulish text-shadow-lg md:text-lg">
                                {{
                                    product?.name
                    ...
                    <div class="absolute flex items-center justify-between bottom-2 left-2 right-2">
                        ...
                        <div :class="cartStore.checkIfProductExistInCart(product.id)
                            ? 'bg-[#1FC8F3]'
                            : 'bg-white'
                            "
                            ...
                            <svg :class="cartStore.checkIfProductExistInCart(
                                ...
                                ? 'text-white'
                                : 'text-black'
                                " class="w-4 h-4 group-hover/cart:text-white" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
