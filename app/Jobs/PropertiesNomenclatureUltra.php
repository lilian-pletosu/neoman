...
class PropertiesNomenclatureUltra implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    public $tries = 10; // Numărul de încercări
    ...
    public function handle()
    {
        ...
        Log::info("Attempt number: $attempt, in PROPERTIES service for GUID:", [$this->guid]);
        ...
        do {
            try {
                ...
                Log::info("Status for PROPERTIES is: ", [$status]);
            } catch (\Exception $e) {
        ...
        Redis::set("PROPERTIES", json_encode($data));

        Log::info('PROPERTIES process is done!');
    }
    ...
    {
        (new UltraImportService())->commitReceivingData('PROPERTIES');
    }
